...
public class MyFragmentTabHost extends TabHost
    ...
    private TabValidator mValidator;
    ...
    public void setTabValidator(TabValidator validator) {
    ...
    public void onTabChanged(String tabId) {
        if (mValidator != null && !mValidator.isTabValid(tabId)) {
            // unfortunately our parent tab host won't hear us out and
            // thinks this tab is already selected at this stage,
            // let's be a dutiful child and wipe our parent's ass, shall we?!
            if (mLastTab != null) {
                int index = getIndexByTag(mLastTab.tag);
                setCurrentTab(index);
            }
            return;
        }
...
//            throw new IllegalStateException("No tab known for tag " + tabId);
            // since  onAttachToWindow also invoke this method... maybe it's still null in this case ,so we just return null...
            return null;
        }
        if (mLastTab != newTab) {
            if (ft == null) {
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    if (mFragmentFactory != null) {
                        newTab.fragment = mFragmentFactory.createTabFragment(mContext, newTab.tag, newTab.args);
                        if (newTab.fragment == null) {
                            throw new IllegalStateException("no fragment is created by fragment factory");
                        }
                    } else {
    ...
    public interface FragmentFactory {
        Fragment createTabFragment(Context context, String tag, Bundle args);
    }
