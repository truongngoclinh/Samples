...
public class BannerPager extends ViewPager {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<BannerPager> autoScrollViewPager;

        public MyHandler(BannerPager autoScrollViewPager) {
            this.autoScrollViewPager = new WeakReference<BannerPager>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    BannerPager pager = this.autoScrollViewPager.get();
                    if (pager != null) {
